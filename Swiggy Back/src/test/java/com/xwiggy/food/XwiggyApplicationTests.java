...
public class XwiggyApplicationTests {
    ...
    public void contextLoads() {
        ...
        login.setUsername("akila101");
        login.setPassword("Akila@12345");

        User user = userDaoImpl.validateUser(login);
        Assert.assertEquals("Akila",user.getFirstname());
        Assert.assertEquals("Konda",user.getLastname());
        Assert.assertEquals("akila@gmail.com",user.getEmail());
